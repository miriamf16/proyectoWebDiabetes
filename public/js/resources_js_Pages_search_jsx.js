...
var fetch = function fetch(variable, clave) {
  ...
  for (i = 1; i < aux1.length; i++) {
    if (aux2.localeCompare(aux1[i]) == 0) {
      result = 1;
      break;
    }
  }
...
var Home = function Home() {
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(document.CC),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    "aria-current": "page"
  }, t('search')))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "row"
